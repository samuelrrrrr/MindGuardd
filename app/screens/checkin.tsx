    ...
    >
      ...
      >
        <View style={{ paddingHorizontal: 22, paddingBottom: 0 }}>
          ...
          <Text style={styles.heroSub}>Take a moment to reflect on your day.</Text>
        </View>
      </LinearGradient>
      ...
      <View style={styles.content}>
          ...
          <View style={styles.moodRow}>
            {moods.map((m) => (
              ...
              >
                ...
                <Text style={[styles.moodLabel, { color: mood === m.l ? C.purple : C.muted }]}>
                  {m.l}
                </Text>
              </TouchableOpacity>
            ))}
        ...
        <Card>
          <View style={styles.rowBetween}>
            ...
            <Text style={[styles.sliderValue, { color: C.purple }]}>{sleep}/10</Text>
          </View>
          <Slider
            minimumValue={0}
            maximumValue={10}
        ...
        <Card>
          <View style={styles.rowBetween}>
            ...
            <Text style={[styles.sliderValue, { color: C.amber }]}>{stress}/10</Text>
          </View>
          <Slider
            minimumValue={0}
            maximumValue={10}
        ...
        {/* ACTIVITIES */}
        <Card>
          <Text style={[styles.sectionLabel, { marginBottom: 12 }]}>Activities</Text>
          <View style={styles.actGrid}>
            {acts.map((a) => (
              ...
              >
                ...
                <Text style={[styles.actLabel, { color: act === a.l ? C.purple : C.sub }]}>
                  {a.l}
                </Text>
              </TouchableOpacity>
            ))}
...
const styles = StyleSheet.create({
  ...
  sectionLabel: { fontSize: 11, fontWeight: '700', color: C.sub, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 12 },
  ...
  moodBtn: { flex: 1, marginHorizontal: 2, borderRadius: 14, paddingVertical: 9, paddingHorizontal: 4, alignItems: 'center', gap: 5, borderWidth: 2, borderColor: 'transparent', backgroundColor: 'transparent' },
  moodLabel: { fontSize: 9, fontWeight: '700' },

  actGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  actBtn: { width: '47%', flexDirection: 'row', alignItems: 'center', gap: 10, borderRadius: 16, padding: 14, borderWidth: 2, borderColor: 'transparent', backgroundColor: C.bg },
  actLabel: { fontSize: 14, fontWeight: '600' },

  savedRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingVertical: 18 },
  savedText: { fontSize: 16, fontWeight: '800', color: C.mint },

  saveBtn: { borderRadius: 99, paddingVertical: 17, paddingHorizontal: 24, alignItems: 'center', shadowColor: C.purple, shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.4, shadowRadius: 12, elevation: 6 },
